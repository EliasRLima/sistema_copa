...
<html class="no-js">
	...
	<body>
           <div class="pesquisador-esquerda">
                ...
                <a href="?area=1" class="btn btn-primary btn-lg btn-block">Nova Patente</a> 
                <a href="?area=2" class="btn btn-primary btn-lg btn-block">Pedidos de Reajuste</a>
                <a href="?area=3" class="btn btn-primary btn-lg btn-block">Minhas Patentes</a>
                <a href="?area=4" class="btn btn-warning btn-lg btn-block">Pedir revogacao</a> </br></br>
                    ...
                    ?>
                        <div class="aviso">
                            ...
                            <div class="alert alert-success" role="alert">
                                        A solicitacao da patente <a href="" class="alert-link">NOME PATENTE</a> foi aprovada.
                            </div>
                            <div class="alert alert-danger" role="alert">
                                        A solicitacao da patente <a href="" class="alert-link">NOME PATENTE</a> foi reprovada.
                            </div>
                            <div class="alert alert-warning" role="alert">
                                        Necessarios ajustes em <a href="" class="alert-link">NOME PATENTE</a> até DD/MM/YYYY.
                            </div>
                        </div>
                    <?php
                  }
                            ...
                            if($area == 1){
                                ...
                                ?>
                                    <form id="cadastro" method="POST" action="patente/cadastro" class="p-3 mb-2 bg-dark text-white">
                                        <h3 style="color: #007bff">Cadastro de patente</h3></br>
				                        
                                        <div class="form-group">
                                            <label for="patente_name">Nome da patente</label>
                                            <input type="text" class="form-control" name="patente_name" id="patente_name" value="" maxlength="100" placeholder="Digite o nome da patente..." autofocus/>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="patente_descricao" name="patente_descricao" rows="10" value="oi"></textarea>
                                        </div>
